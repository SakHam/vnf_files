...
def start():
  ...
  cmd = 'sudo mkdir -m 777 "/home/ubuntu/monitoring/data/"' + camera_name
  os.system(cmd)
  ...
  cmd = 'sudo touch ' + path + '/MqttInfluxDB_' + camera_name + '.py'
  os.system(cmd)
  ...
  with open('/home/ubuntu/monitoring/grafana/panel.json', 'r') as file :
